...
Recommended host: **native 64-bit Debian Bookworm/Trixie or Raspberry Pi OS**, because that is the formally supported environment for `rpi-image-gen`. WSL2/container builds may work but are not the primary supported path.
...
The generated image and SHA256 manifest appear in `release/`.
