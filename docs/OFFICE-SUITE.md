...
Vibe-coder's OS Raspberry Edition 1.3.0 adds a native productivity stack while keeping the Vibe Windows-inspired shell separate from the Linux foundation.
